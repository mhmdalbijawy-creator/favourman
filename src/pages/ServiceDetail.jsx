                        ...
                        <div className="bg-charcoal border border-gold/10 p-10 md:p-14 relative group">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 mb-12">
                                <button
                                    ...
                                    className={`flex-1 py-4 text-[10px] uppercase font-bold tracking-[0.15em] transition-all duration-700 border ${selectedType === 'request' ? 'border-gold text-gold bg-gold/5' : 'border-white/5 text-gray-400 hover:border-gold/30'}`}
                                >
                                    {t('service_detail.acquire')}
                                </button>
                                <button
                                    onClick={() => setSelectedType('partner')}
                                    className={`flex-1 py-4 text-[10px] uppercase font-bold tracking-[0.15em] transition-all duration-700 border ${selectedType === 'partner' ? 'border-gold text-gold bg-gold/5' : 'border-white/5 text-gray-400 hover:border-gold/30'}`}
                                >
                                ...
                                {isSubmitted ? (
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className="group relative w-full py-6 bg-transparent border border-gold/40 hover:border-gold text-gold uppercase font-bold tracking-[0.4em] text-[10px] overflow-hidden transition-all duration-700 hover:scale-[1.02] active:scale-95 shadow-lg"
                                        >
