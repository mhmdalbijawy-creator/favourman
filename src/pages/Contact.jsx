                            ...
                            {isSubmitted ? (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className="w-full py-6 bg-gold text-rich-black uppercase font-black tracking-[0.5em] text-xs hover:bg-white transition-all duration-700 disabled:opacity-50 transform hover:scale-[1.02]"
                                    >
