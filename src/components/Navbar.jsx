            ...
            <AnimatePresence mode="wait">
                {isOpen && (
                    <>
                        ...
                        <motion.div initial={{ x: '100%' }} animate={{ x: 0 }} exit={{ x: '100%' }} transition={{ type: 'tween', duration: 0.4, ease: "circOut" }} className="fixed top-0 right-0 h-full w-full sm:w-[80%] max-w-[400px] bg-[#000000] z-[70] lg:hidden flex flex-col shadow-2xl border-l border-white/10">
