                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed top-0 right-0 h-full w-full sm:w-[80%] max-w-[400px] bg-rich-black z-50 lg:hidden flex flex-col shadow-2xl border-l border-white/5"
                        >
                            {/* Header */}
                                ...
                                {links.map((link, i) => (
                                    ...
                                    >
                                        <Link
                                            to={link.path}
                                            onClick={() => setIsOpen(false)}
                                            className={`text-xl font-bold uppercase transition-all duration-500 hover:text-gold ${location.pathname === link.path ? 'text-gold' : 'text-white'} ${isAr ? 'tracking-normal text-right' : 'tracking-[0.2em]'}`}
                                        >
                                            {link.name}
                                        </Link>
                                    </motion.div>
                            ...
                            <div className="p-8 border-t border-white/5">
                                <button
                                    ...
                                    className="w-full bg-gold/10 border border-gold/30 py-4 text-gold uppercase text-xs font-bold tracking-widest hover:bg-gold hover:text-rich-black transition-all"
                                >
